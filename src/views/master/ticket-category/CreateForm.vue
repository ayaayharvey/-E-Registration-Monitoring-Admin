...
import { useTicketCategoryStore } from "../../../stores/master/TicketCategoryStore";
...
export default {
	...
	setup() {
		...
		const { formData, saving } = storeToRefs(ticketCategoryStore);
		const { toggleCreateForm, submitForm, onSubmit } = ticketCategoryStore;
